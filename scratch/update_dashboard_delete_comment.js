...
// 1. CONFIG update
const oldEntry = '{ id: "createComment", name: "Create Comment", method: "POST", endpoint: "/0/0/sosyal/yorum-olustur/0/", inputs: ["postID", "yorumicerik", "kategori", "kimeyanit"], desc: "Post a new comment", auth: true }';
...
const oldExec = `        } else if (action.id === 'createComment') {
...
const newExec = oldExec + ` else if (action.id === 'deleteComment') {
